 ...
 * In real usages, the callbacks should execute in 
 * a separate thread or thread pool
 */
public class ApplicationMasterAsync implements AMRMClientAsync.CallbackHandler {
    ...
    String hdfsInputDirectory;
    String hdfsOutputDirectory;

    public ApplicationMasterAsync(String command, int numContainersToWaitFor, String hdfsInputDirectory, String hdfsOutputDirectory) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ApplicationMasterAsync master = new ApplicationMasterAsync(command, n, hdfsInputDirectory, hdfsOutputDirectory);
        master.runMainLoop();
